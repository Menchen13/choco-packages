...
# Check if the user's processor is ARM-based. If not, default to standard AMD64.
...
Install-ChocolateyZipPackage @packageArgs # https://docs.chocolatey.org/en-us/create/functions/install-chocolateypackage
